...
#ifndef HAVOC_I_ENGINE_TRACE_H_
...
#define MASK_NPCSOLID_BRUSHONLY                                                  \
  (CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_WINDOW | CONTENTS_MONSTERCLIP | \
   CONTENTS_GRATE)
...
class ITraceFilter {
 public:
  ...
  virtual bool ShouldHitEntity(CEntity *entity, int32_t contentsMask) = 0;
  virtual int32_t GetTraceType() const = 0;
};
...
class CTraceFilter : public ITraceFilter {
 public:
  ...
  int32_t GetTraceType() const override {
