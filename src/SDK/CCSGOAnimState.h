...
#ifndef HAVOC_C_CSGO_ANIM_STATE_H_
#define HAVOC_C_CSGO_ANIM_STATE_H_
...
class CCSGOAnimState {
 public:
  ...
  char __pad00C0[4]; //0x00C0
  CVector origin; //0x00C4
  CVector lastOrigin; //0x00D0
  float velocityX; //0x00DC Speeds on axis
  float velocityY; //0x00E0 ^^^^^^^^^^
  char __pad00E4[4]; //0x00E4
